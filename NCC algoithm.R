...
b <- c(averageacc1(mydata, 2, 20), averageacc2(mydata, 2, 20))


b

credalsingleacc <- c(averageacc1(mydata, 0, 10)[1], averageacc1(mydata, 0.5, 10)[1],averageacc1(mydata, 1, 10)[1],averageacc1(mydata, 1.5, 10)[1],averageacc1(mydata, 2, 10)[1],averageacc1(mydata, 2.5, 10)[1],averageacc1(mydata, 3, 10)[1])
credalsingleacc

credalindet <- c(averageacc1(mydata, 0, 10)[2], averageacc1(mydata, 0.5, 10)[2],averageacc1(mydata, 1, 10)[2],averageacc1(mydata, 1.5, 10)[2],averageacc1(mydata, 2, 10)[2],averageacc1(mydata, 2.5, 10)[2],averageacc1(mydata, 3, 10)[2])

credaldeterminacy <- (1-credalindet)*100 
credaldeterminacy
